...
class __TwigTemplate_61ebe901aa45743e14fad12954759057 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-success mt-2 w-100\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "activite/_form.html.twig", "/var/www/html/test/cc33/templates/activite/_form.html.twig");
    }
}
