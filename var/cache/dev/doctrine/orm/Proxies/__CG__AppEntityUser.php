...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\User' . "\0" . 'activites', '' . "\0" . 'App\\Entity\\User' . "\0" . 'ActivitesInscrit'];
        }
     ...
     * {@inheritDoc}
     */
    public function getActivitesInscrit(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActivitesInscrit', []);

        return parent::getActivitesInscrit();
    }

    /**
     * {@inheritDoc}
     */
    public function addActivitesInscrit(\App\Entity\Activite $activitesInscrit): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addActivitesInscrit', [$activitesInscrit]);

        return parent::addActivitesInscrit($activitesInscrit);
    }

    /**
     * {@inheritDoc}
     */
    public function removeActivitesInscrit(\App\Entity\Activite $activitesInscrit): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeActivitesInscrit', [$activitesInscrit]);

        return parent::removeActivitesInscrit($activitesInscrit);
    }
